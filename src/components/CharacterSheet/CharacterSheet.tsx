    ...
    <div className={`min-h-screen bg-bg-main text-text-main bg-neural-gradient bg-fixed${demoMode ? ' demo-mode' : ''}`}>
      ...
      <main className="max-w-7xl mx-auto px-3 sm:px-6 py-6 sm:py-10">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-6 auto-rows-min">
                          ...
                          <>
                            ...
                            {llmContent && (
                              <a
                                ...
                                title="Eksportuj profil na Social Media lub stopkę maila"
                              >
                                <svg fill="none" stroke="currentColor" strokeWidth="2" viewBox="0 0 24 24" aria-hidden="true" style={{width:15,height:15}}>
            ...
            <SectionDivider label="Cechy Charakterystyczne" />
