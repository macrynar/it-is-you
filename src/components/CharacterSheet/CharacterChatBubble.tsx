    ...
    <div className="fixed bottom-5 right-5 z-[60]">
      {!open ? (
        <button
          ...
          className="w-12 h-12 rounded-full bg-bg-surface/90 border border-white/10 hover:border-brand-primary/40 backdrop-blur-xl shadow-lg flex items-center justify-center text-white/80 hover:text-white transition"
        ...
        <div className="w-[360px] max-w-[calc(100vw-40px)] h-[520px] max-h-[calc(100vh-140px)] bg-bg-surface/90 border border-white/10 rounded-2xl backdrop-blur-xl shadow-2xl flex flex-col overflow-hidden">
          <div className="px-4 py-3 border-b border-white/10 flex items-center justify-between">
            <div className="min-w-0">
              <div className="text-xs tracking-[2px] font-mono text-white/45">ASYSTENT</div>
